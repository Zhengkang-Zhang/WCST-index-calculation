...
check_subset(wcst_long[,c('category_completed')] %>% unique(),c(0,1,2,3,4,5,6),tip="The colomn of 'category_completed' classically should be 0~6, but yours contain:")
...
### Columns depend on:  'color_rule', 'shape_rule', 'number_rule', 'category_completed', 'button_pressed'
